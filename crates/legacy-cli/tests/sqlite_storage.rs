...
use wayfind_v1_cli::sqlite::SqliteStorage;
use wayfind_v1_core::{
...
fn a_cleared_initiative_is_no_longer_the_newest_but_is_still_readable() {
    ...
    let excluding = storage
        .newest_initiative(
            wayfind_v1_core::InitiativeSelector {
                project_key: &key,
                scope: wayfind_v1_core::InitiativeScope::ExcludingClear,
            },
            Consistency::Strong,
        )
    ...
    let any = storage
        .newest_initiative(
            wayfind_v1_core::InitiativeSelector {
                project_key: &key,
                scope: wayfind_v1_core::InitiativeScope::AnyStatus,
            },
            Consistency::Strong,
        )
        .expect("read the newest initiative");
...
fn attach(
    ...
    storage
        .store_attachment(
            wayfind_v1_core::StoreAttachment {
                id,
                ticket_id,
