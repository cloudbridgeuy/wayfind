...
//! writing output. It holds no business rule; it asks `wayfind_v1_core` for every
...
use clap::Parser;
use wayfind_v1_cli::app;
use wayfind_v1_cli::args::Cli;
use wayfind_v1_cli::context::SystemEnvironment;
